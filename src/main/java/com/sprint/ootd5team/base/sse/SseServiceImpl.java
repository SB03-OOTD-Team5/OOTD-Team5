...
public class SseServiceImpl implements SseService {
    ...
    private final SseMessageRepositoryImpl sseMessageRepositoryImpl;
    ...
    public SseEmitter connect(UUID userId, UUID lastEventId) {
        ...
        // 이벤트 유실 복원
        if (lastEventId != null) {
            List<SseMessage> missed = sseMessageRepositoryImpl.findAfter(lastEventId);
    ...
    public void broadcast(String eventName, Object data) {
        ...
        sseMessageRepositoryImpl.save(message);
