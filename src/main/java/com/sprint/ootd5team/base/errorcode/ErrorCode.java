...
public enum ErrorCode {
    ...
    WEATHER_OPEN_FETCH_FAILED(HttpStatus.BAD_GATEWAY, "Open-Meteo 데이터를 가져오는데 실패했습니다."),
    WEATHER_OPEN_PARSE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "Open-Meteo 데이터를 분석하는데 실패했습니다."),
